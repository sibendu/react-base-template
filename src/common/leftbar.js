                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseDashboards" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                                <nav class="drawer-menu-nested nav">
                                    <a href="#" class="nav-link" onClick={()=>handleClick("CustomerAllView")}>Customer</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                                <nav class="drawer-menu-nested nav">
                                    <a class="nav-link" href="layout-dark.html">My tasks</a>
                                    <a class="nav-link" href="layout-light.html">Menu 2</a>
                                    <a class="nav-link" href="layout-static.html">Menu 3</a>
                                </nav>
                            </div>
                            {
                ((userroles.includes("admin")||userroles.includes("superadmin")) &&
                            ...
                            <div class="collapse" id="collapseForms" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                                <nav class="drawer-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="forms-checks-and-radios.html">Menu 2</a>
